...
SELECT 'event' AS entity, count() AS latest_rows FROM `Data_Prediction_Service`.polymarket_event_latest FINAL
UNION ALL
SELECT 'market' AS entity, count() AS latest_rows FROM `Data_Prediction_Service`.polymarket_market_latest FINAL
UNION ALL
SELECT 'series' AS entity, count() AS latest_rows FROM `Data_Prediction_Service`.polymarket_series_latest FINAL;
